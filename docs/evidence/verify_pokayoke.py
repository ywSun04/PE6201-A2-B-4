...
def main():
    ...
    print(RULE)
    print("  ALL NINE ARE tools.ToolError SUBCLASSES, so agent.py can catch")
    ...
    print("                              % err.detail}")
    print()
    print("  The existing agent.py ToolError clause catches these and records")
    print("  one failed decision rather than ending the full evaluation.")
    print(RULE)
